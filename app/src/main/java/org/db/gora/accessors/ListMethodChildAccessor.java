...
/**
 * List method child accessor. See {@link org.db.gora.ChildAccessor}
 * <p> The getter method is expected to create an instance of List interface
 *
 * @author Sergey Kolupaev &lt;skolupaev@gmail.com&gt;
 */

public final class ListMethodChildAccessor implements ChildAccessor {
    final Method mGetter;

    public ListMethodChildAccessor(Method getter) {
        this.mGetter = getter;
    }
